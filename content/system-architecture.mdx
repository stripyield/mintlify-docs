...
3. The vault **harvests yield** and splits it:
   - **89% Growth** - Stays in the vault, compounds the principal base
   - **10% Buybacks** - Used to buy STRIP from the market, anchoring price to yield
   - **1% Protocol Fee** - Covers operations

### **The Key Parts**

- **StripVault** - Holds your deposits and manages yield.
- **PT/STRIP Pool** - Where PT and STRIP trade. Heavily weighted to PT for stability.
