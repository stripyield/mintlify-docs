...
PT/STRIP liquidity providers deepen the market between principal claims and STRIP. All liquidity flows through the **PoolWrapper**, which issues **sWLP**, the fungible, stakeable LP token and the only LP position that exists on the canonical pool.
