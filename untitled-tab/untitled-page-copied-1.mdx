...
**How it works**\
\
Strip uses **StripVaults** to manage deposits. Each vault accepts a yield-bearing asset (like sUSDe), gives you **PT** tokens, and handles the yield split. Every vault has its own **PT/STRIP pool** weighted 92/8.[**​**](https://strip.mintlify.app/essentials/settings#what-happens-when-you-deposit)
...
3. The vault **harvests yield** and splits it:
   ...
   - **1% Protocol Fee** - Covers operations, also used for STRIP buybacks[**​**](https://strip.mintlify.app/essentials/settings#the-key-parts)
