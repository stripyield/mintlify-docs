...
Vaults generate yield. Half of that yield compounds, expanding the base that produces future yield. The remaining half removes STRIP from circulation. A larger base produces more yield in subsequent cycles, increasing both compounding and buybacks.
