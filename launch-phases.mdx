---
title: "Launch Phases"
description: "How Strip launches: the 30-day Genesis window, an onchain claims date, and a published emission-split policy."
---
...
During the 30 days, the productive base builds and realized yield accumulates. Buybacks cannot execute yet, because buying STRIP requires a market and none exists during Genesis. That is the point: the entire month of routed yield banks in the BuybackBurner as accumulated firepower. When trading opens, STRIP does not launch on a promise of future demand; it launches into a month of banked demand, deployed as the first buybacks and burns once the market exists, each one visible on the [transparency dashboard](/transparency). Emissions during this window also flow entirely to the participants building the base, rather than to trading activity that does not yet exist.
...
- **The banked yield:** the yield shares accumulating in the BuybackBurner during Genesis, onchain throughout.
- **The first burns:** the BuybackBurner's execution log once trading opens, deploying the yield banked during Genesis.
