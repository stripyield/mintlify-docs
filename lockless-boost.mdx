...
- The STRIP inside your staked [sWLP](/pt-strip-liquidity) position
...
<Warning>
Assets held by third-party contracts are outside the boost system. If you deposit STRIP or sWLP into a lending market, bridge, or exchange, that exposure is no longer attributed to your address, and your clock treats it as a reduction. Integrations may be recognized in the future; until one is explicitly listed, assume it is not.
</Warning>
